...
export default function DriversPage() {
  ...
  return (
    <div className="flex flex-col gap-6 font-vazir">
      {/* هدر صفحه دقیقا با استایل خوش‌آمدگویی داشبورد */}
      ...
      {/* بخش آمار دقیقا مثل StatCard های داشبورد */}
      <DriverStats {...stats} />

      {/* بدنه اصلی - جدول با استایل کارت‌های نقشه */}
      <motion.section
      ...
      >
        ...
        <div className="flex flex-col gap-4 border-b border-slate-100 p-6 dark:border-slate-800/50 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-2">
            <button className="flex items-center gap-2 rounded-xl border border-slate-200 px-4 py-2.5 text-xs font-semibold text-slate-600 transition-colors hover:bg-slate-50 dark:border-slate-800 dark:text-slate-400 dark:hover:bg-slate-800">
              <Filter size={14} />
              فیلتر پیشرفته
            </button>
