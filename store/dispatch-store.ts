          ...
          try {
            ...
            set({
              ...
              error:
                getErrorMessage(
                  error,
                  'بارگذاری مأموریت با خطا مواجه شد.',
                ),
            });
          }
        },
          ...
          try {
            ...
            try {
              ...
              try {
                ...
                console.warn(
                  '[DispatchStore] reload dispatches failed:',
                  listError,
                );
              }
            }
        ...
        async (
          ...
          try {
            ...
            try {
              ...
              console.warn(
                '[DispatchStore] status refresh failed:',
                error,
              );
            }
          } catch (
